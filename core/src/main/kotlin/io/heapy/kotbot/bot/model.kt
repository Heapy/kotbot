...
//}
//
//internal fun ApiUpdate.toTelegramUpdate(): List<TelegramUpdate> {
//    val update = this
...
//) : TelegramUpdate
//
//internal fun EditedMessage(update: ApiUpdate): EditedMessage {
...
//) : TelegramUpdate
//
//internal fun ChannelPost(update: ApiUpdate): ChannelPost {
//    return ChannelPost(
//        updateId = update.update_id,
//        messageId = update.message!!.message_id
//    )
...
//) : TelegramUpdate
//
//internal fun EditedChannelPost(update: ApiUpdate): EditedChannelPost {
...
//) : TelegramUpdate
//
//internal fun InlineQuery(update: ApiUpdate): InlineQuery {
//    return InlineQuery(
//        updateId = update.update_id,
//        messageId = update.message!!.message_id
//    )
...
//) : TelegramUpdate
//
//internal fun ChosenInlineResult(update: ApiUpdate): ChosenInlineResult {
...
//) : TelegramUpdate
//
//internal fun CallbackQuery(update: ApiUpdate): CallbackQuery {
...
//) : TelegramUpdate
//
//internal fun ShippingQuery(update: ApiUpdate): ShippingQuery {
...
//) : TelegramUpdate
//
//internal fun PreCheckoutQuery(update: ApiUpdate): PreCheckoutQuery {
...
//) : TelegramUpdate
//
//internal fun Poll(update: ApiUpdate): Poll {
//    return Poll(
//        updateId = update.update_id,
//        messageId = update.message!!.message_id
//    )
...
//) : TelegramUpdate
//
//internal fun PollAnswer(update: ApiUpdate): PollAnswer {
//    return PollAnswer(
//        updateId = update.update_id,
//        messageId = update.message!!.message_id
//    )
