 ...
 */
@Serializable
public data class SendRichMessage(
    /**
...
) : Method<SendRichMessage, Message> by Companion {
    public companion object : Method<SendRichMessage, Message> {
        override val _deserializer: KSerializer<Response<Message>> =
                Response.serializer(Message.serializer())

        override val _serializer: KSerializer<SendRichMessage> = serializer()

        override val _name: String = "sendRichMessage"
    }
}
