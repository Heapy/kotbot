 ...
 */
@Serializable
public data class GetUserGifts(
    /**
...
) : Method<GetUserGifts, OwnedGifts> by Companion {
    public companion object : Method<GetUserGifts, OwnedGifts> {
        override val _deserializer: KSerializer<Response<OwnedGifts>> =
                Response.serializer(OwnedGifts.serializer())

        override val _serializer: KSerializer<GetUserGifts> = serializer()

        override val _name: String = "getUserGifts"
    }
}
