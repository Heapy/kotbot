...
) : Method<EditStory, Story> by Companion {
    public companion object : Method<EditStory, Story> {
        override val _deserializer: KSerializer<Response<Story>> =
                Response.serializer(Story.serializer())

        override val _serializer: KSerializer<EditStory> = serializer()

        override val _name: String = "editStory"
    }
}
